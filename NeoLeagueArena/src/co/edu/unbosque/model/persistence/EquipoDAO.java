...
public class EquipoDAO implements OperacionDAO<EquipoDTO, Equipo> {
	...
	/**
	 * Constructor de la clase EquipoDAO Inicializa la lista de equipos y carga los
	 * datos desde el archivo serializado.
	 * 
	...
	/**
	 * add Agrega un nuevo equipo a la lista de equipos.
	 * 
	...
	public boolean add(EquipoDTO newData) {
		if (newData.getTorneosInscritos() == null && newData.getIntegrantes() == null
				&& newData.getPartidasJugadas() == null) {
	...
	/**
	 * delete Elimina un equipo de la lista de equipos.
	 * 
	...
	/**
	 * find Busca un equipo en la lista de equipos.
	 * 
	...
	/**
	 * update Actualiza un equipo en la lista de equipos.
	 * 
	...
	/**
	 * 
	 * @return listaEquipos Devuelve la lista de equipos
	...
	/**
	 * setListaEquipos Establece la lista de equipos.
	 * 
	 * @param listaEquipos la lista de equipos a establecer
	 * @return listaEquipos Devuelve la lista de equipos
	 */
	...
	/**
	 * escribirArchivoTxt Escribe la lista de equipos en un archivo de texto.
	 */
	...
	/**
	 * escribirArchivoSerializado Escribe la lista de equipos en un archivo
	 * serializado.
	 * 
	 * @param listaEquipos la lista de equipos a establecer
	 * @return listaEquipos Devuelve la lista de equipos
	...
	/**
	 * leerArchivoSerializado Lee la lista de equipos desde un archivo serializado.
	 * 
	 * @param listaEquipos la lista de equipos a establecer
	 * @return listaEquipos Devuelve la lista de equipos
	 */
