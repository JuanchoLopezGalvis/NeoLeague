...
public class AdministradorDTO extends Usuario {
	...
	/**
	 * Esta instancia es la encargada de guardar la contraseña de los
	 * administradores que para aumentar la seguridad del aplicativo para que no
	 * cualquiera pueda administrar la información.
	 */
