...
public class PanelActualizarPartida extends JPanel{
	...
	public PanelActualizarPartida() {
		...
		btnActualizarPartida = new BotonRedondeado("Actualizar Partida", 20, java.awt.Color.decode("#002d69"), java.awt.Color.black, java.awt.Color.WHITE, java.awt.Color.white, 1f);
