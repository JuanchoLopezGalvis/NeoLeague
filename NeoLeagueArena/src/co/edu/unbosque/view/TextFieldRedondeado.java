...
public class TextFieldRedondeado extends JTextField{
    ...
    /**
     * Este atributo es el encargado de guardar el color del borde del text field.
     */
    private Color borderColor;
    /**
	 * Este atributo es el encargado de guardar el color del fondo del text field.
	 */
    private Color background;
    /**
     * Este atributo es el encargado de guardar el color del texto del text field.
     */
    ...
    /**
	 * Este metodo se encarga de pintar del text field con los bordes redondeados.
	 */
    @Override
