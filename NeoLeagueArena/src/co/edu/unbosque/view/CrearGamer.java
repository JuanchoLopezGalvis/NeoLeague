...
public class CrearGamer extends JPanel{
	 ...
	 */
	private JComboBox<String> datoTrayectoriaCompetitiva;
	/**
	...
	/**
	 * Este atributo es el encargado de guardar el boton para crear el gamer.
	 */
	private BotonRedondeado botonCrearGamer;
	/**
	...
	public CrearGamer() {
		...
		String[] txtTrayectoria = {"How many tournaments have you played?", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten or more"};
		...
		datoTrayectoriaCompetitiva.setBounds(580, 420, 250, 30);
		seleccionarFoto.setBounds(580, 490, 250, 30);
		botonCrearGamer.setBounds(580, 630, 250, 30);
		...
		datoTrayectoriaCompetitiva.setBackground(Color.decode("#002d69"));
		datoTrayectoriaCompetitiva.setForeground(Color.white);
		...
		add(datoEdad);
		add(datoPais);
		add(datoTrayectoriaCompetitiva);
	 ...
	 * @return datoTrayectoriaCompetitiva
	 */
	public JComboBox<String> getDatoTrayectoriaCompetitiva() {
		return datoTrayectoriaCompetitiva;
	}
	/**
	 * Este metodo se encarga de establecer el combo box para la trayectoria competitiva.
	 * @param datoTrayectoriaCompetitiva
	 */
	public void setDatoTrayectoriaCompetitiva(JComboBox<String> datoTrayectoriaCompetitiva) {
		this.datoTrayectoriaCompetitiva = datoTrayectoriaCompetitiva;
	}
	/**
	...
	/**
	 * Este metodo se encarga de obtener el boton para crear el gamer.
	 * @return botonCrearGamer
	 */
	public BotonRedondeado getBotonCrearGamer() {
		return botonCrearGamer;
	}
	/**
	 * Este metodo se encarga de establecer el boton para crear el gamer.
	 * @param botonCrearGamer
	 */
	public void setBotonCrearGamer(BotonRedondeado botonCrearGamer) {
		this.botonCrearGamer = botonCrearGamer;
	}
	/**
