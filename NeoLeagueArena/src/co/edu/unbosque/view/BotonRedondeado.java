...
public class BotonRedondeado extends JButton{
	 ...
	 * @param borderWidth
	 */
    public BotonRedondeado(String text, int cornerRadius, Color colorPorDefecto, Color colorInteraccion, Color colorForegraund, Color borderColor, float borderWidth) {
        super(text);
